...
class test_buy_tickets(unittest.TestCase):
    ...
    def test_buy_tickets(self):
        ...
        self.login(wd, username="alexey", password="lolo")
        self.fill_flight_details(wd)
        self.click_select_flight(wd)
        self.choose_flight(wd)
        self.click_book_flight(wd)
        self.fill_reservation(wd, Flight(name="Alexey", lastname="Kozlov", name2="Alexey's", lastname2="Wife"))
        self.click_purchase(wd)


    def test_buy_tickets_2(self):
        wd = self.wd
        self.open_home_page(wd)
        self.login(wd, username="alexey", password="lolo")
        self.fill_flight_details(wd)
        ...
        self.choose_flight(wd)
        self.click_book_flight(wd)
        self.fill_reservation(wd, Flight(name="Vania", lastname="Taiwania", name2="Zozo", lastname2="Koleso"))
        self.click_purchase(wd)


    def click_purchase(self, wd):
    ...
    def fill_reservation(self, wd, flight):
    ...
    def click_book_flight(self, wd):
        wd.find_element_by_name("reserveFlights").click()

    def choose_flight(self, wd):
        if not wd.find_element_by_xpath(
    ...
    def click_select_flight(self, wd):
        wd.find_element_by_name("findFlights").click()

    def fill_flight_details(self, wd):
        wd.find_element_by_name("tripType").click()
        if not wd.find_element_by_xpath(
                "//div/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[5]/td/form/table/tbody/tr[3]/td[2]/b/select//option[2]").is_selected():
            wd.find_element_by_xpath(
